...
Carousel.DEFAULTS={interval:15000,pause:'hover',wrap:!0}
...
else{if(this.$element.parent().parent().hasClass("navbar-nav")){if($('.navbar-toggle').is(":visible")){this[this.$element.hasClass('in')?'hide':'show']()}}else{this[this.$element.hasClass('in')?'hide':'show']()}}}
function Plugin(option){return this.each(function(){var $this=$(this)
