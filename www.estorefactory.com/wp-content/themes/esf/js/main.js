...
$(document).ready(function () {
    ...
    equalHeight($(".page-id-18 .services-box")); //equalHeight 
});

$(window).resize(function(){ equalHeight($(".page-id-18 .services-box")) }); //equalHeight 

function equalHeight(group) { //equalHeight
   tallest = 0;
   group.each(function() {
